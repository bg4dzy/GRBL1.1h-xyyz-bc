...
This means you cannot upload the HEX file via the bootloader.
  ...
  2. Wire up the two Arduino boards as shown in the figure below.
     [wire your boards](https://docs.arduino.cc/static/a2d9d884287f098ba5ef53a61943adc5/e07e9/MegaToUNO.jpg)
  3. Run command:
     ```
